    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100 py-4 sm:py-12">
      <div className="container max-w-7xl px-2 sm:px-4 lg:px-8">
        ...
        <Tabs defaultValue="regular" className="space-y-6">
          {/* 主導航標籤 */}
          <TabsList className="flex flex-wrap h-auto gap-1 sm:gap-2 p-1.5 sm:p-2 w-full bg-muted/50 rounded-lg">
            <TabsTrigger value="regular" className="text-[10px] sm:text-sm px-1.5 sm:px-4 py-2 sm:py-2 border border-blue-300 bg-blue-50 text-blue-700 rounded-md data-[state=active]:border-blue-500 data-[state=active]:bg-blue-100 data-[state=active]:shadow-sm active:scale-95 transition-transform font-semibold">{"📋"}<span className="hidden sm:inline"> 恆常班管理</span><span className="sm:hidden"> 恆常</span></TabsTrigger>
            ...
            <TabsTrigger value="exam" className="text-[10px] sm:text-sm px-1.5 sm:px-4 py-2 sm:py-2 border border-red-300 bg-red-50 text-red-700 rounded-md data-[state=active]:border-red-500 data-[state=active]:bg-red-100 data-[state=active]:shadow-sm active:scale-95 transition-transform font-semibold">{"🥋"}<span className="hidden sm:inline"> 考試評分</span><span className="sm:hidden"> 考試</span></TabsTrigger>
            <TabsTrigger value="users" className="text-[10px] sm:text-sm px-1.5 sm:px-4 py-2 sm:py-2 border border-border rounded-md data-[state=active]:border-primary data-[state=active]:bg-background data-[state=active]:shadow-sm active:scale-95 transition-transform">{"👤"}<span className="hidden sm:inline"> 用戶管理</span><span className="sm:hidden"> 用戶</span></TabsTrigger>
            <TabsTrigger value="whatsapp" className="text-[10px] sm:text-sm px-1.5 sm:px-4 py-2 sm:py-2 border border-border rounded-md data-[state=active]:border-primary data-[state=active]:bg-background data-[state=active]:shadow-sm active:scale-95 transition-transform">{"💬"}<span className="hidden sm:inline"> WhatsApp範本</span><span className="sm:hidden"> WA</span></TabsTrigger>
            <TabsTrigger value="receipt-review" className="text-[10px] sm:text-sm px-1.5 sm:px-4 py-2 sm:py-2 border border-yellow-300 bg-yellow-50 text-yellow-700 rounded-md data-[state=active]:border-yellow-500 data-[state=active]:bg-yellow-100 data-[state=active]:shadow-sm active:scale-95 transition-transform font-semibold">{"📋"}<span className="hidden sm:inline"> 收據審查</span><span className="sm:hidden"> 收據</span></TabsTrigger>
            <TabsTrigger value="push-queue" className="text-[10px] sm:text-sm px-1.5 sm:px-4 py-2 sm:py-2 border border-indigo-300 bg-indigo-50 text-indigo-700 rounded-md data-[state=active]:border-indigo-500 data-[state=active]:bg-indigo-100 data-[state=active]:shadow-sm active:scale-95 transition-transform font-semibold relative">
              {"🔔"}<span className="hidden sm:inline"> 推播審核</span><span className="sm:hidden"> 推播</span>
                  ...
                  <Table className="min-w-[1050px]">
                     <TableHeader className="sticky top-0 z-20 bg-background">
                       <TableRow>
                         ...
                         <TableHead className="sticky left-[52px] z-30 bg-background whitespace-nowrap px-2 sm:px-3 min-w-[100px] border-r border-slate-200">姓名</TableHead>
                        ...
                        const isInactive = student.status === 'inactive';
                         ...
                         return (
                           <TableRow key={student.id} className={`${isInactive ? 'opacity-50' : ''}`}>
                             <TableCell className={`sticky left-0 z-10 font-medium text-muted-foreground px-2 sm:px-3 text-xs whitespace-nowrap ${venueColor || 'bg-white'}`}>{index + 1}</TableCell>
                             <TableCell className={`sticky left-[52px] z-10 font-medium px-2 sm:px-3 whitespace-nowrap border-r border-slate-200 ${venueColor || 'bg-white'}`}>
