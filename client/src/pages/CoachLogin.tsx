...
export default function CoachLogin() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-green-50 via-teal-50 to-green-100 flex items-center justify-center p-4">
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          ...
          <h1 className="text-3xl font-bold text-gray-900 mb-2">教練管理系統</h1>
          <p className="text-gray-600">管理學生資料,查看統計報表</p>
        </div>
        ...
        <Card className="shadow-xl border-0">
          <CardHeader className="bg-gradient-to-r from-green-600 to-teal-600 text-white rounded-t-lg">
            ...
            <CardDescription className="text-green-100">請輸入您的電話號碼和密碼</CardDescription>
          </CardHeader>
